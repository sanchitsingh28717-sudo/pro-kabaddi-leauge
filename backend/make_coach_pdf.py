...
def create_coach_pdf():
    ...
    json_path = os.path.join(base_dir, "frontend", "src", "data", "coach_credentials.json")
    ...
    pdf.cell(0, 10, "KabaddiIQ - Coach Login Credentials", align="C", new_x="LMARGIN", new_y="NEXT")
    pdf.ln(5)
    ...
    pdf.cell(col_w1, line_h, "Team Name", border=1, align="C")
